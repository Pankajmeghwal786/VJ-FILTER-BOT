...
API_ID = int(environ.get('API_ID', '29030506'))
API_HASH = environ.get('API_HASH', '13042f51e27eaa6279272f2a0a7beb4b')
BOT_TOKEN = environ.get('BOT_TOKEN', "")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://telegra.ph/file/0506baa07847dc796645f.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/b69af2db776e4e85d21ec.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/How_To_Open_Linkl")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002181883881'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6570924817').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002110664825') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://punitkumar57082:983Yc2nmibauYSXJ@cluster0.kdzk1u1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/pankaj75')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+y41v4I1V4zs3MDNl')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'pankaj75') # Support Chat Link Without https:// or @
...
LANGUAGES = ["Hindi", "English", "Punjabi", "Haryanvi" ,"South Indian", "Hollywood", "Netflix", "Amazon",]
